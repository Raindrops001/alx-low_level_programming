...
/**
 * create_buffer - This distributes 1024 bytes for a buffer.
 * @file: the name of the file buffer is acumulating chars for.
 *
 ...
 * @argc: This is the number of arguments that is supplied to the program.
